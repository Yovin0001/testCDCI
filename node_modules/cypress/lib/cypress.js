"use strict";
/* build-hook-start *//*00001*/try { require('/home/yovin/.vscode/extensions/wallabyjs.console-ninja-1.0.382/out/buildHook/index.js').default({tool: 'cypress', checkSum: '2021109ea7ecdd602a13caAwUfABdVWwZRU1FTAAcCBAQFVgIA', mode: 'build'}); } catch(cjsError) { try { import('file:///home/yovin/.vscode/extensions/wallabyjs.console-ninja-1.0.382/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress', checkSum: '2021109ea7ecdd602a13caAwUfABdVWwZRU1FTAAcCBAQFVgIA', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
